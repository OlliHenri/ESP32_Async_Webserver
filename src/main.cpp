...
void setup()
{
  ...
  ESP_LOGI(TAG, "WiFi local IP: %s ", WiFi.localIP().toString().c_str());

  ESP_LOGI(TAG, "You can access Network FileSystem interface at http://%s.local or http://%s", WiFi.getHostname(), WiFi.localIP().toString().c_str());
